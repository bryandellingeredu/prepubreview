...
export default function SentFromSupervisorConfirmation() {
  ...
  return (
    <div style={{ padding: '20px', textAlign: 'center' }}>
      <Message positive icon size="large" className='industry'>
        ...
        <Message.Content>
          <Message.Header className='industry'>Your Supervisor Review Has Been Recorded!</Message.Header>
          {status === 'accept' &&
          <>
          Thank you for reviewing this publication
          <p> this publication will be sent to the Subject Matter Expert/s for review</p>
